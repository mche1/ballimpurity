BImp_subsample=function(n,D,setid,splitid,d){ 
  ######BImp_subsample calculates the Ball Impurity of a subsample of n individuals out of 
  ###### totally N individuals, with a set of split ids which are subset of this subsample.
  ##### distance matrix is given as D, of dimension n by N; and the subsample indices are 
  ####  given in setid; split indices are given in splitid (note, split ids are the positions
  ###   they are in the subsample. E.g. the subsample is (10,20,...,19000)-th of the original
