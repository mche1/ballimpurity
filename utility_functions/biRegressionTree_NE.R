...
bestSplit <- function(dataset, D, leafFunc=regLeaf, method='BallImpurity', ops=c(0, 4), lastSplitFeat=NULL, lossChoice="loss2") {
  ...
  # input: dataset, leafFunc- the method to compute the leaf; method - loss function; ops - parameters specifying the tolerances on loss and N,  lastSplitFeat - 存放上一次分裂的节点
